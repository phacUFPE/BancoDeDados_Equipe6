...
SELECT func.nome, tfunc.telefone, COUNT(tfunc.telefone) FROM funcionario func
INNER JOIN telefone_funcionario tfunc ON tfunc.cod_funcionario = func.cpf
GROUP BY func.nome
HAVING COUNT(tfunc.telefone) > 1;
